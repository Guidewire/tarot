package com.guidewire.security;
...
public class NonValidatingSSLSocketFactory extends SSLSocketFactory {
  public static final SocketFactory DEFAULT = new NonValidatingSSLSocketFactory();
  ...
  public static SocketFactory getDefault() {
    return new NonValidatingSSLSocketFactory();
  }

  public static String factoryName() {
    return NonValidatingSSLSocketFactory.class.getName();
  }

  private SSLSocketFactory factory;

  private NonValidatingSSLSocketFactory() {
    try {
